...
mod tests {
    ...
    fn diagnostics() -> ContextSelectionDiagnostics {
        ContextSelectionDiagnostics {
            ...
            memory_active_considered: 0,
            memory_scoped_selected: 0,
            memory_global_selected: 0,
            memory_global_masked: 0,
            memory_always_include_selected: 0,
            memory_deleted_unconfirmed_excluded: 0,
